 ...
 * =====================================================================================
 *
 *       Filename:  linear_container_darray.c
 *
 *    Description:  linear_container_darray c source file 
 *
 *        Version:  1.0
 *        Created:  04/11/2019 05:36:22 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
static Ret linear_container_darray_get_by_nidex(LinearContainer* thiz,size_t index,void** data)
{
    PrivInfo* priv = (PrivInfo*)thiz=>priv;
...
sttaic void linear_container_darray_destroy(LinearContainer* thiz)
{
    PrivInfo* priv = (PrivInfo*)thiz->priv;
...
LinearContainer* linear_container_darray_create(DataDestroyFunc data_destroy,void* ctx)
{
    ...
    if(thiz != NULL)
    {
        ...
        thiz->get_by_index = linear_container_darray_get_by_nidex;
