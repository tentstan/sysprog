 ...
 * =====================================================================================
 *
 *       Filename:  darray_iterator.c
 *
 *    Description:  darray_iterator c source file 
 *
 *        Version:  1.0
 *        Created:  04/03/2019 09:44:46 AM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
static void darray_iterator_destory(Iterator* thiz)
{
    if(thiz != NULL)
    {
        free(thiz);
...
Iterator* darray_iterator_create(DArray* darray)
{
    ...
    if((thiz = malloc(sizeof(Iterator) + sizeof(PrivInfo))) != NULL)
    {
        ...
        thiz->destroy = darray_iterator_destory;
