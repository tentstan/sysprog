 ...
 *       Filename:  invert.c
 *
 *    Description:  invert c source file 
 *
 *        Version:  1.0
 *        Created:  03/05/2019 02:28:33 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
Ret invert(Iterator* forward,Iterator* backward)
{
    ...
    for(;iterator_offset(forward) < iterator_offset(backward);iterator_next(forward),iterator_next(backward))
    {
