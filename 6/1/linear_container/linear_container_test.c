 ...
 * =====================================================================================
 *
 *       Filename:  linear_container_test.c
 *
 *    Description:  linear_container_test c source file 
 *
 *        Version:  1.0
 *        Created:  03/04/2019 09:51:30 AM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
static void test_invalid_params(void)
{
    ...
    assert(linear_container_find(NULL,NULL,NULL) == RET_INVALID_PARAMS);
