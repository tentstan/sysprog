 ...
 * =====================================================================================
 *
 *       Filename:  linear_container.h
 *
 *    Description:  linear_container head file 
 *
 *        Version:  1.0
 *        Created:  03/01/2019 04:41:14 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
typedef Ret (*LinearContainerForeach)(LinearContainer* thiz,DataVisitFunc visit,void* data);
