 ...
 * =====================================================================================
 *
 *       Filename:  locker_nest.c
 *
 *    Description:  locker_nest c source file 
 *
 *        Version:  1.0
 *        Created:  01/30/2019 03:38:05 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
Locker* lock_nest_create(Locker* real_locker,TaskSelfFunc task_self)
{
    Locker* thiz = NULL;
