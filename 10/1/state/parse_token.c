 ...
 * =====================================================================================
 *
 *       Filename:  parse_token.c
 *
 *    Description:  parse_token c source file 
 *
 *        Version:  1.0
 *        Created:  04/25/2019 11:34:51 AM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
int main(int argc,char* argv[])
{
    ...
    assert(parse_token("/backup/tools/jdk1.5.0_18/bin/:/usr/bin/qt-3.3/bin/:usr/kerberos/bin/:/backup/tools/jdk1.5.0_18/bin/:/usr/lib/ccache:/usr/local/bin/:/usr/bin/:/bin:/home/tentstan/bin",":",on_token,NULL) == 9);
    assert(parse_token("/backup/tools/jdk1.5.0_18/bin/","/",on_token,NULL) == 4);

    return 0;
}

#endif /* PARSE_TOKEN_TEST */
