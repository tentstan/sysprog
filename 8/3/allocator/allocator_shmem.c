 ...
 * =====================================================================================
 *
 *       Filename:  allocator_shmem.c
 *
 *    Description:  allocator_shmem c source file 
 *
 *        Version:  1.0
 *        Created:  04/24/2019 04:57:54 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
Allocator* allocator_shmem_create(void* addr,size_t length)
{
    ...
    buffer = mmap(addr,length,PROT_READ | PROT_WRITE,MAP_SHARED | MAP_ANONYMOUS,-1,0);
